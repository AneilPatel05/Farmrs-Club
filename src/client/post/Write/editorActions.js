...
export function createPost(postData) {
  ...
  return (dispatch, getState, { steemConnectAPI }) => {
    ...
    const newBody = isUpdating ? getBodyPatchIfSmaller(postData.originalBody, body) : body + '<br/><div class="pull-right promo"><sub>' +'<p>This post was made from https://farmr.club</p></sub></div>';
