...
@Form.create()
@withEditor
class EditorSurpassingGoogle extends React.Component {
  static propTypes = {
      ...
      <div>
        <div>
          <Collapse defaultActiveKey={['1']}>
            <Panel header="The Art of Surpassing Google" key="1">
              <p>
              The Art of Surpassing Google
              </p>
            </Panel>
          </Collapse>
        </div>
...
export default EditorSurpassingGoogle;
